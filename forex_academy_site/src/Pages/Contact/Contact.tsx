...
import { Phone, Send, Instagram, MessageSquare, Ticket } from "lucide-react";
...
export default function ContactHero() {
  ...
  <>
    <section
      ...
      style={{
        backgroundImage: "url('https://res.cloudinary.com/djeorsh5d/image/upload/v1761804514/06f5adb8-b5f4-4516-ba21-82078fb4cb98.png')",
    ...
    >
      ...
      <div className="relative z-10 max-w-2xl">
        ...
        <p className="text-gray-300 mb-8 leading-relaxed">
          Encountering an issue or seeking clarification about our services?  
          Submit a <span className="text-[#00ffcc] font-semibold">support ticket</span> to let us know your concern,  
          or reach out directly via our social platforms.  
          We typically respond within <span className="font-semibold">2–4 hours</span>.
        </p>
